...
def preprocess(filename):
	...
	pickle.dump(transition_prob,f1)
	pickle.dump(emission_prob,f1)
	pickle.dump(tagcounter,f1)
	pickle.dump(vocabsize,f1)
	pickle.dump(outerTransitions,f1)
	pickle.dump(sent_cnt,f1)
	...
	for trans_tup in transition_prob:
		if trans_tup[1]=='start':
			...
			transition_prob[trans_tup]/= outerTransitions[trans_tup[0]]
